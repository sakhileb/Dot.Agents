<x-layouts.platform>
    <x-slot:header>Knowledge</x-slot:header>
    <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-12 text-center">
        ...
        <h3 class="font-bold text-gray-900 dark:text-white mb-2">Knowledge — Coming Soon</h3>
        <p class="text-sm text-gray-500 dark:text-gray-400">This module is under active development.</p>
    </div>
</x-layouts.platform>
