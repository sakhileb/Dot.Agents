...
/**
 * Registers all built-in PHP skill implementations into a SkillRegistryService.
 *
 * Extracted from SkillRegistryService::bootBuiltInSkills() to keep the registry
 * class under 200 lines while maintaining a single, auditable list of all skill
 * class bindings.
 */
class SkillRegistryBootstrapper
{
    public static function register(SkillRegistryService $registry): void
    {
        $builtIns = [
            // ── Day One Skills ──────────────────────────
